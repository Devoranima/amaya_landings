    ...
    <div className='hero_bg bg-gradient-to-r from-[#f87413] to-[#ffa13d] relative'>
      ...
      <div className="container relative z-10 w-full pt-10">
        <div className="flex flex-col items-center text-center lg:text-left lg:items-start">
          <div className="sm:ml-6 font-fut w-full">
            <h1 className='leading-[0.9em] sm:text-7xl my-6 w-full lg:w-1/2 2xl:w-1/3'>Добро пожаловать в <br /> <span className='sm:text-8xl'>Amaya+</span></h1>
            <h2 className='leading-tight sm:text-4xl 2xl:text-5xl mb-4 lg:mb-12 font-sans lg:w-1/2 2xl:w-1/3'>Играйте, учитесь и веселитесь с нашим сборником из более <b>25 увлекательных приложений</b>.</h2>
          </div>

          <img src="amaya/index/characters.webp" alt="" className='hidden lg:block w-full lg:w-3/5 static lg:absolute right-0 top-1/2 lg:-translate-y-1/2'/>
          <img src="amaya/index/characters_mobile.webp" alt="" className='w-full right-0 top-1/2 lg:hidden'/>
          ...
          <div className='block lg:hidden bg-[#ee6b09] text-3xl line-clamp-2 text-center w-full py-6 px-0 rounded-[3rem] mb-8 leading-snug font-fut'>
