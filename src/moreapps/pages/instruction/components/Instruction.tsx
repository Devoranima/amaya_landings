    ...
    <div className='container flex flex-col items-center text-center text-main font-fut py-10'>
      ...
      <div className="w-full md:hidden flex flex-col items-center">
        <div className="max-w-[80vw] w-full mt-10 flex flex-col items-center text-2xl">
          <div className="">
            <img src="amaya/instruction/mobile/1.webp" alt="" />
            Скачай и открой приложение
          </div>
          <ArrowDown />
          <div className="">
            <img src="amaya/instruction/mobile/2.webp" alt="" />
            В приветственном окне выбери “Войти в аккаунт”
          </div>
          <ArrowDown />
          <div className="  ">
            <img src="amaya/instruction/mobile/3.webp" alt="" />
        ...
        <div className="max-w-[80vw] mt-10 w-full flex flex-col items-center text-2xl">
          <div className="">
            <img src="amaya/instruction/mobile/4.webp" alt="" />
            Зайди в родительсикй раздел
          </div>
          <ArrowDown />
          <div className="">
            <img src="amaya/instruction/mobile/5.webp" alt="" />
            Войди в раздел “Аккаунт”
          </div>
          <ArrowDown />
          <div className="  ">
            <img src="amaya/instruction/mobile/6.webp" alt="" />
      ...
      <div className="w-full hidden md:block">
        <div className="w-full mt-10 flex flex-row items-start justify-between text-2xl text-center">
          <div className="w-1/4">
            <img src="amaya/instruction/tablet/1.webp" alt="" className='w-full'/>
            Скачай и открой приложение
          </div>
          <ArrowRight />
          <div className="w-[28.5%]">
            <img src="amaya/instruction/tablet/2.webp" alt="" className='w-full'/>
            В приветственном окне выбери “Войти в аккаунт”
          </div>
          <ArrowRight />
          <div className="w-1/4">
            <img src="amaya/instruction/tablet/3.webp" alt="" className='w-full'/>
            В окне авторизации, введи тот логин
            и пароль, которые вводил на сайте
          </div>
        </div>
        ...
        <div className="w-full mt-10 flex flex-row items-start justify-between text-2xl text-center">
          <div className="w-[26%]">
            <img src="amaya/instruction/tablet/4.webp" alt="" className='w-full'/>
            Зайди в родительсикй раздел
          </div>
          <ArrowRight />
          <div className="w-[25%]">
            <img src="amaya/instruction/tablet/5.webp" alt="" className='w-full'/>
            Войди в раздел “Аккаунт”
          </div>
          <ArrowRight />
          <div className="w-1/4">
            <img src="amaya/instruction/tablet/6.webp" alt="" className='w-full'/>
            Введи тот логин и пароль, который вводил на сайте
          </div>
        </div>
      </div>
      <img src="amaya/instruction/shared/kid.webp" alt="" className='mt-4'/>
