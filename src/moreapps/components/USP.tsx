      ...
      <Body className="mt-10">
        ...
        <div className="lg:flex flex-row-reverse w-full">
          ...
          <div className="w-full lg:min-w-1/3 relative">
            <img src="amaya/index/shared/iphone.webp" alt="" className="w-1/2 mx-auto z-10 relative lg:-rotate-6 lg:w-full"/>
            <img src="amaya/index/shared/spot.svg" alt="" className="absolute w-full lg:min-w-[160%] -translate-x-1/2 lg:left-1/3 left-1/2 top-1/2 -translate-y-1/2 z-0" />
            ...
            <img src="amaya/index/shared/bubble.svg" alt="" className="absolute w-2/5 top-0 right-0 z-10 lg:w-3/4 2xl:w-2/3 lg:top-10 xl:top-8 lg:-right-6 lg:-rotate-6"/> 
          </div>
        </div>
      </Body>
    </Section>
