  ...
  return (
    <div className='bg-gradient-to-r -mt-40 pt-60 pb-20 relative'>
      <div className="container text-center flex flex-col items-center relative z-10">
        <h1 className="font-fut text-4xl mb-4">Учебное путешествие, которое меняется вместе с вашим ребёнком</h1>
        <h2 className="text-3xl mb-10">Нажмите на круги, чтобы узнать чему они научатся на каждом этапе</h2>
