...
const cards: T_Card[] = [
  {
    ...
    image: "amaya/index/shared/Card1.webp"
  },
  {
  ...
  },
  {
    ...
    image: "amaya/index/shared/Card5.webp"
  },
]
...
export default function USP() {
  ...
  return (
    <Section className="mt-4">
      <Header className="">Играй и веселись вместе с<br/><span className="text-3xl lg:text-5xl">Amaya+</span></Header>
      <Body className="mt-10">
        ...
        <div className="lg:flex flex-row-reverse w-full *:basis-1/3 relative items-stretch">
          ...
          <div className="relative mt-10 lg:mt-0 w-full lg:w-1/3 z-0 lg:absolute left-0 top-0">
            <img src="amaya/index/shared/iphone.webp" alt="" className="w-3/5 mx-auto z-10 relative lg:-rotate-6 lg:w-full"/>
            <img src="amaya/index/shared/spot.svg" alt="" className="absolute min-w-[140%] -translate-x-1/2 lg:left-1/3 left-1/2 top-1/2 -translate-y-1/2 z-0" />
            <div className="absolute w-3/5 top-0 right-0 z-10">
              <div className="relative">
                <div className="max-w-full absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 z-20 rotate-12 text-accent font-fut text-center text-xl">
                  Посмотрите видео об<br/>
                  <img src="amaya/Logo.webp" alt="" className="w-full mx-auto"/>
                </div>
